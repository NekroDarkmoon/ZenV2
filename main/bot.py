...
# --------------------------------------------------------------------------
description = """
Bot for Personal/Community DnD servers.
"""
...
class Zen(commands.AutoShardedBot):
    ...
    async def before_identify_hook(self, shard_id, *, initial) -> None:
    ...
    async def add_to_blacklist(self, object_id) -> None:
        await self.blacklist.put(object_id, True)


    async def remove_from_blacklist(self, object_id) -> None:
        try:
